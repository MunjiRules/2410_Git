...
{
    private Transform target = null; // Build메소드 호출할때 팝업창을 꾸며주기 위한 멤버변수
    private string title = null; 
    private string description = null; 
    private List<PopupButtonInfo> buttonInfoList = null;  // 생성자에서 부모타겟 매개변수로 가져온다.
    ...
    { 
        ...
        GameObject popupObject = GameObject.Instantiate(Resources.Load("PopupPanel", typeof(GameObject))) as GameObject; 
    ...
    public void SetButton(Sprite _text, CallbackEvent _callback) 
    { 
